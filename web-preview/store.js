...
const APP_BUILD="2026-08-30-admin-plans4317a";
...
function show(id){
  if(id==='driver'||id==='admin'||id==='admin-detail'||id==='admin-create'||id==='admin-claim'||id==='admin-catalogs-screen'||id==='admin-activity-screen'||id==='admin-billing-screen'||id==='admin-plans-screen'||id==='admin-links-screen'||id==='admin-vehicle-card'||id==='customer-portal'){
  ...
  const wide = id==='admin'||id==='admin-detail'||id==='admin-create'||id==='admin-claim'||id==='admin-catalogs-screen'||id==='admin-activity-screen'||id==='admin-billing-screen'||id==='admin-plans-screen'||id==='admin-links-screen'||id==='admin-vehicle-card'||id==='customer-portal';
