...
const SIGN_OPERATOR_LETTER_CATALOG = [
  ...
  {
    id: 'signDriver',
    title: 'Водитель — выпуск подписи (T2/T4)',
    hint: 'ПЭП водителя для приёма и выдачи груза (титулы перевозчика)',
    role: 'driver'
  }
];
...
Просим выпустить **простую электронную подпись (ПЭП)** для водителя {{carrier.name}} (ИНН {{carrier.inn}}) — подтверждение титулов T2 (приём) и T4 (выдача) в ЭТрН.
