...
(function () {
  var APP_BUILD = '2026-08-30-admin-plans4317a';
  ...
  function shellScripts() {
    ...
    else if (isA) files.push('qrcode.min.js', 'entry-share.js', 'order-documents.js', 'etrn.js', 'admin.js', 'admin-plans.js', 'onboarding.js');
