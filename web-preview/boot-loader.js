...
(function () {
  var APP_BUILD = '2026-08-31-customer-portal-tabs4317';
  ...
  function shellScripts() {
    ...
    else if (isA) files.push('qrcode.min.js', 'entry-share.js', 'print-window.js', 'order-documents.js', 'doc-templates.js', 'operator-letters.js', 'admin-profile.js', 'etrn.js', 'admin.js', 'admin-docs.js', 'admin-plans.js', 'onboarding.js');
