...
(function(){
  ...
  const TOURS={
    ...
    driver:[
      {
        title:'Главная',
        body:'<p>Сводка дня: километры, заработок и статус смены.</p><p>Баннеры «Выехал» / «Прибыл» и кнопки смены статуса. Лента чата — только при закрытии заказа или своём заказе; ЕТО и карточки — во вкладках «ЕТО» и «Заявки».</p>',
        target:'btn-home',
        placement:'top'
      },
      {
        title:'ЕТО',
        body:'<p>Ежедневный техосмотр: авто, одометр, жидкости и свет.</p><p>Откройте смену на Главной — осмотр пройдёте здесь. Без ЕТО заказы в работу не берутся.</p>',
        target:'btn-eto',
        placement:'top'
      },
      {
